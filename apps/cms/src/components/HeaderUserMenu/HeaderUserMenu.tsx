      ...
      >
        ...
        <Menu.Dropdown>
          ...
          >
            ...
            <div>{`${user.role[0]}${user.role.slice(1).toLowerCase()}`}</div>
          </Menu.Item>
          ...
          <Menu.Item
            ...
            onClick={() => navigate(`/dashboard/blog/posts?filter=${user.id}`)}
          >
            Your posts
          </Menu.Item>
          <Menu.Item
            ...
            onClick={() =>
              navigate(`/dashboard/blog/comments?filter=${user.id}`)
            }
          >
            Your comments
          </Menu.Item>
          ...
          <Menu.Item
            ...
            onClick={() => navigate(`/dashboard/users/${user.username}/edit`)}
          >
            Account settings
          </Menu.Item>
